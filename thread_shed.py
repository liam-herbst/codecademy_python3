...
for tran in daily_transactions_split:
  transactions_c = []
  for i in tran:
    transactions_c.append(i.strip())
  transactions_clean.append(transactions_c)
...
for color in colors:
  print("There were {number} of {color} sold today".format(number=color_count(color), color=color))
